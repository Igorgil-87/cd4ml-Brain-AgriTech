...
def load_soja_solo_transformado(engine,file_path = "/app/data/raw_data/rendimento/sojasolo_transformado.csv"):
    table_name = "soja_solo_transformado"
    headers = {
    ...
    try:
        ...
        logging.info(f"Encoding soja_solo_transformado {encoding} encontrado com sucesso!")        
