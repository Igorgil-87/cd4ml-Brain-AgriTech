...
def load_arroz_solo_transformado(engine, file_path="/app/data/raw_data/rendimento/arrozsolo_transformado.csv"):
    table_name = "arroz_solo_transformado"
    headers = {
    ...
    try:
        ...
        logging.info(f"Encoding  arroz_solo_transformado {encoding} encontrado com sucesso!")
